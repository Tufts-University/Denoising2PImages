...
# NADH CARE SSIML2 deep seed 1 ⏰ ⏰ 
# NADH CARE SSIML2 deep seed 2 ⏰ ⏰ 
# NADH CARE SSIML2 deep seed 3 ⏰ ⏰ 
# NADH CARE SSIML2 deep seed 4 ⏰ ⏰ 40686069        
python -u main.py config.json trial_name="NADH_CARE_0928_cervix_SSIML2_seed3"
python -u main.py config.json mode=eval trial_name="NADH_CARE_0928_cervix_SSIML2_seed3" fad_data=NV_928_FAD_Testing.npz nadh_data=NV_928_NADH_Testing.npz
