...
#SBATCH --output=../NADH_CAREmodel_0713_cervix_SSIMPCC_ap5_Wavelet_bior1p1.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_CAREmodel_0713_cervix_SSIMPCC_ap5_Wavelet_bior1p1.%j.err  #saving standard error to file -- %j jobID -- %N nodename
