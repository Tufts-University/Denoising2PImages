...
#SBATCH --output=../NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_morl.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_morl.%j.err  #saving standard error to file -- %j jobID -- %N nodename
