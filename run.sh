...
#SBATCH --output=../NADH_CARE_0823_cervix_SSIML2_seed3.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_CARE_0823_cervix_SSIML2_seed3.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
# NADH CARE + SSIML2 ap84 SSIM deep seed 3 ⏰ ⏰ ⏰ ⏰ cc1gpu001 39713146   
