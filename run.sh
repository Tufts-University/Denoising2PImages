...
#SBATCH --output=../COLPO_LEEP_NADH_CAREmodel_0713_cervix_SSIMR2_ap5_Wavelet_bior1p1_deep_fs3.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../COLPO_LEEP_NADH_CAREmodel_0713_cervix_SSIMR2_ap5_Wavelet_bior1p1_deep_fs3.%j.err  #saving standard error to file -- %j jobID -- %N nodename
