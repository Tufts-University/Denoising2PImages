...
#SBATCH --error=../NADH_CARE_0823_cervix_SSIML2_seed0.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
# NADH CARE + SSIML2 ap84 SSIM deep seed 0 ⏰ ⏰ ⏰ ⏰ 39714238   
...
# NADH CARE + SSIML2 ap84 SSIM deep seed 2 ⏰ ⏰ ⏰ ⏰
