...
# NADH CARE + SSIML2 ap84 SSIM deep seed 1 ⏰ ⏰
...
# python -u main.py eval care "NADH_CARE_0823_cervix_SSIML2_seed0" cwd=.. fad_data=NV_907_FAD_Colpo.npz nadh_data=NV_907_FAD_Colpo.npz val_seed=0 val_split=4 test_split=8 test_flag=1 train_mode=0
# python -u main.py eval care "NADH_CARE_0823_cervix_SSIML2_seed0" cwd=.. fad_data=NV_907_FAD_Leep.npz nadh_data=NV_907_FAD_Leep.npz val_seed=0 val_split=4 test_split=8 test_flag=1 train_mode=0
### PCC ##########################################################
