...
#SBATCH --output=../NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_gaus.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_gaus.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
# python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_haar" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2 wavelet=True wavelet_function=haar

# NADH RCAN SSIMR2 ap5 Wavelet Morl ⏰
# python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_morl" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2 wavelet=True wavelet_function=morl

# NADH RCAN SSIMR2 ap5 Wavelet Gaus ⏰
python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_gaus" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2 wavelet=True wavelet_function=gaus
