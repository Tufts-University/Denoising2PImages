...
#SBATCH --output=../NADH_SRGAN_0823_cervix_SSIMR2_seed2.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_SRGAN_0823_cervix_SSIMR2_seed2.%j.err  #saving standard error to file -- %j jobID -- %N nodename
