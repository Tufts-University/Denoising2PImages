...
#SBATCH --output=../NADH_CAREmodel_0713_cervix_SSIMR2_Wavelet_Bior4.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_CAREmodel_0713_cervix_SSIMR2_Wavelet_Bior4.%j.err  #saving standard error to file -- %j jobID -- %N nodename
