...
# Frequency Testing with LFN (FAD CARE Testing Wavelet MAE)
python -u main.py eval wunet "FAD_CARETesting_Wavelet_0928_cervix_SSIMR2_new_seed0" cwd=.. fad_data=NV_LFN_FAD_Testing.npz nadh_data=NV_LFN_NADH_Testing.npz val_seed=0 val_split=25 ssim_FSize=3 ssim_FSig=0.5 wavelet_function=bior1.1 loss=SSIMR2
