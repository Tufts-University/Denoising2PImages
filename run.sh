...
#SBATCH --output=../NADH_CARETesting_Wavelet_0928_cervix_MAE_new_seed0.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_CARETesting_Wavelet_0928_cervix_MAE_new_seed0.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
python -u main.py eval wunet "NADH_CARETesting_Wavelet_0928_cervix_MAE_new_seed0" cwd=.. fad_data=NV_928_FAD_Testing.npz nadh_data=NV_928_NADH_Testing.npz loss="mae" wavelet_function="mae.1" val_seed=0 val_split=25 ssim_FSize=3 ssim_FSig=0.5
