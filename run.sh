...
#SBATCH --output=../Eval_CARE_SRGAN.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../Eval_CARE_SRGAN.%j.err  #saving standard error to file -- %j jobID -- %N nodename
