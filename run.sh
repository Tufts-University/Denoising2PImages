...
#SBATCH --output=../FAD_CAREmodel_0713_cervix_SSIML1_BS50.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../FAD_CAREmodel_0713_cervix_SSIML1_BS50.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
# FAD CARE SSIML1 
python -u main.py eval care "FAD_CAREmodel_0713_cervix_SSIML1_BS50" cwd=.. nadh_data=NV_713_NADH_healthy.npz unet_n_depth=4
# ID1: 25160324; New IDs: 25250404 (2), 25250493 (3), 
