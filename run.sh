...
#SBATCH --output=../NADH_SRGAN.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_SRGAN.%j.err  #saving standard error to file -- %j jobID -- %N nodename
