...
# python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_haar" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2_loss wavelet=True wavelet_function=haar

# NADH RCAN SSIMR2 ap5 Wavelet Morl ⏰
# python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_morl" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2_loss wavelet=True wavelet_function=morl

# NADH RCAN SSIMR2 ap5 Wavelet Gaus ⏰
# python -u main.py train rcan "NADH_model_0713_cervix_SSIMR2_ap5_Wavelet_gaus" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2_loss wavelet=True wavelet_function=cgau1
...
python -u main.py train care "NADH_CAREmodel_0713_cervix_SSIMR2_ap5_Wavelet_bior4p4" cwd=.. nadh_data=NV_713_NADH_healthy.npz loss=ssimr2_loss wavelet=True wavelet_function=bior4.4
