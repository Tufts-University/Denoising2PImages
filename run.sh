...
#SBATCH --output=../NADH_SRGAN_0823_cervix_SSIMR2_seed1_new.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_SRGAN_0823_cervix_SSIMR2_seed1_new.%j.err  #saving standard error to file -- %j jobID -- %N nodename
...
# NADH SRGAN  residual blocks seed 1
