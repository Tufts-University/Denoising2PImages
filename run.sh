...
#SBATCH --output=../FAD_CARETesting_Wavelet_0928_cervix_SSIMFFL_seed0.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../FAD_CARETesting_Wavelet_0928_cervix_SSIMFFL_seed0.%j.err  #saving standard error to file -- %j jobID -- %N nodename
