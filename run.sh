...
#SBATCH --output=../FAD_WUnet_0928_cervix_SSIMR2_new_seed0_loss.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../FAD_WUnet_0928_cervix_SSIMR2_new_seed0_loss.%j.err  #saving standard error to file -- %j jobID -- %N nodename
