...
#SBATCH --output=../NADH_CARE_0823_cervix_SSIMR2_ap5_Wavelet_bior1p1_seed2.%j.out  #saving standard output to file -- %j jobID -- %N nodename
#SBATCH --error=../NADH_CARE_0823_cervix_SSIMR2_ap5_Wavelet_bior1p1_seed2.%j.err  #saving standard error to file -- %j jobID -- %N nodename
