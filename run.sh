...
python -u main.py config.json trial_name="NADH_CARE_0928_cervix_SSIML2_seed2"
python -u main.py config.json mode=eval trial_name="NADH_CARE_0928_cervix_SSIML2_seed2" fad_data=NV_928_FAD_Testing.npz nadh_data=NV_928_NADH_Testing.npz
