...
def build_wunet(config, 
    ...
    LLmodel = care.build_care(config, 'SXYC')(LL[0])
    LHmodel = care.build_care(config, 'SXYC')(LH[0])
    HLmodel = care.build_care(config, 'SXYC')(HL[0])
    HHmodel = care.build_care(config, 'SXYC')(HH[0])
