...
def build_wunet(config, 
    ...
    LLmodel = care_compile(care.build_care(config, 'SXYC'))(LL)
    LHmodel = care_compile(care.build_care(config, 'SXYC'))(LH)
    HLmodel = care_compile(care.build_care(config, 'SXYC'))(HL)
    HHmodel = care_compile(care.build_care(config, 'SXYC'))(HH)
